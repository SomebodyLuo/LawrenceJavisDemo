...
//			return t  ;
	...
	public  XScroller(Context context,Interpolator i){
		this.mInterpolator = i;
		this.mContext = context;
		mScroller = new Scroller(context,mInterpolator);
	}
	public  XScroller(Context context,float index,float space){
		this.mContext = context;
		mScroller = new Scroller(context,mInterpolator);
		init(index,space);
	}
	public  XScroller(Context context,float index,float space,Interpolator i){
