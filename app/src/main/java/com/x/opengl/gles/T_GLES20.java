...
////		GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
//
//		GLES20.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR_MIPMAP_NEAREST);
//		GLES20.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR_MIPMAP_NEAREST);
...
//		GLUtils.texImage2D
//	    (
//	    		GLES11Ext.GL_TEXTURE_EXTERNAL_OES, //纹理类型
//	     		0, 
////	     		GLUtils.getInternalFormat(bmp),
//	     		bmp, //纹理图像
////	     		GLUtils.getType(bmp), 
...
//	}
	...
	public Texture generateTexture_111(Bitmap bmp) {
...
//        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);
	...
	public Texture generateTexture_meg(Bitmap bmp) {
