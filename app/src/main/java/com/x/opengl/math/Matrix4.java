...
import com.x.opengl.math.vector.Vector3.Axis;
...
public final class Matrix4 implements Cloneable {
    ...
    @NonNull
    @Size(16) private double[]   mTmp   = new double[16]; //A scratch matrix
    @NonNull
    @Size(16) private float[]    mFloat = new float[16]; //A float copy of the values, used for sending to GL.
    @NonNull
